    ...
    )
{
    ...
    PhInsertEMenuItem(menuInfo->Menu, menuItem = PhPluginCreateEMenuItem(PluginInstance, 0, ID_VIEW_WINDOWS, L"&Extended Windows Browser", NULL), insertIndex);
    ...
    case DLL_PROCESS_ATTACH:
        {
            ...
            info->DisplayName = L"Window Explorer Extended";
            info->Author = L"dmex, wj32, poizan42";
